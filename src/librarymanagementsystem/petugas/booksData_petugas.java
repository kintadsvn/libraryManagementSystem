 ...
 * @author ASUS
 */
public class booksData_petugas extends javax.swing.JFrame {

    /**
     * Creates new form dashboard
     */
    public booksData_petugas() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(booksData_petugas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new booksData_petugas().setVisible(true);
            }
        });
    }
