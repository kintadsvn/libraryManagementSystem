 ...
 * @author ASUS
 */
public class borrowAdd_petugas extends javax.swing.JFrame {

    /**
     * Creates new form dashboard
     */
    public borrowAdd_petugas() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(borrowAdd_petugas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new borrowAdd_petugas().setVisible(true);
            }
        });
    }
