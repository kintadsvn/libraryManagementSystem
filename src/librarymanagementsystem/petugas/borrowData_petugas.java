 ...
 * @author ASUS
 */
public class borrowData_petugas extends javax.swing.JFrame {

    /**
     * Creates new form dashboard
     */
    public borrowData_petugas() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Book Title", "Borrowing Date", "Status"
            }
        ) {
        ...
        jButton1.setText("Add New Borrow Transaction");

        jLabel2.setText("ID Borrow");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(borrowData_petugas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new borrowData_petugas().setVisible(true);
            }
        });
    }
