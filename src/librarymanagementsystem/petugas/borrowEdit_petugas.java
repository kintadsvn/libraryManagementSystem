 ...
 * @author ASUS
 */
public class borrowEdit_petugas extends javax.swing.JFrame {

    /**
     * Creates new form dashboard
     */
    public borrowEdit_petugas() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Borrowing Date");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(borrowEdit_petugas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new borrowEdit_petugas().setVisible(true);
            }
        });
    }
